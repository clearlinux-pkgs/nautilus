...
Version  : 46.0
Release  : 91
URL      : https://download.gnome.org/sources/nautilus/46/nautilus-46.0.tar.xz
Source0  : https://download.gnome.org/sources/nautilus/46/nautilus-46.0.tar.xz
...
%prep
%setup -q -n nautilus-46.0
cd %{_builddir}/nautilus-46.0
pushd ..
cp -a nautilus-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710897499
