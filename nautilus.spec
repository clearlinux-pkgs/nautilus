...
Source0  : https://download.gnome.org/sources/nautilus/43/nautilus-43.2.tar.xz
...
%prep
%setup -q -n nautilus-43.2
cd %{_builddir}/nautilus-43.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673299657
