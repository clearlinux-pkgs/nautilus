...
Source0  : https://download.gnome.org/sources/nautilus/48/nautilus-48.2.tar.xz
...
%prep
%setup -q -n nautilus-48.2
cd %{_builddir}/nautilus-48.2
pushd ..
cp -a nautilus-48.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748361541
