...
Source0  : https://download.gnome.org/sources/nautilus/41/nautilus-41.2.tar.xz
...
%prep
%setup -q -n nautilus-41.2
cd %{_builddir}/nautilus-41.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642010056
...
cp %{_builddir}/nautilus-41.2/LICENSE %{buildroot}/usr/share/package-licenses/nautilus/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/nautilus-41.2/libnautilus-extension/LICENSE %{buildroot}/usr/share/package-licenses/nautilus/9a647436aa2324c4cb849c6f3d31c392ed50d9bd
