...
Version  : 3.24.2.1
Release  : 9
URL      : https://download.gnome.org/sources/nautilus/3.24/nautilus-3.24.2.1.tar.xz
Source0  : https://download.gnome.org/sources/nautilus/3.24/nautilus-3.24.2.1.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1500334191
export AR=gcc-ar
