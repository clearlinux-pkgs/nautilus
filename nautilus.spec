...
Version  : 45.2.1
Release  : 90
URL      : https://download.gnome.org/sources/nautilus/45/nautilus-45.2.1.tar.xz
Source0  : https://download.gnome.org/sources/nautilus/45/nautilus-45.2.1.tar.xz
...
%prep
%setup -q -n nautilus-45.2.1
cd %{_builddir}/nautilus-45.2.1
pushd ..
cp -a nautilus-45.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703276704
