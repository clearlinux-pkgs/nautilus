...
Version  : 3.38.1
Release  : 46
URL      : https://download.gnome.org/sources/nautilus/3.38/nautilus-3.38.1.tar.xz
Source0  : https://download.gnome.org/sources/nautilus/3.38/nautilus-3.38.1.tar.xz
...
%prep
%setup -q -n nautilus-3.38.1
cd %{_builddir}/nautilus-3.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601656435
...
cp %{_builddir}/nautilus-3.38.1/LICENSE %{buildroot}/usr/share/package-licenses/nautilus/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/nautilus-3.38.1/libnautilus-extension/LICENSE %{buildroot}/usr/share/package-licenses/nautilus/9a647436aa2324c4cb849c6f3d31c392ed50d9bd
