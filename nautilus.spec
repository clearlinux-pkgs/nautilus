...
Version  : 47.2
Release  : 99
URL      : https://download.gnome.org/sources/nautilus/47/nautilus-47.2.tar.xz
Source0  : https://download.gnome.org/sources/nautilus/47/nautilus-47.2.tar.xz
...
%prep
%setup -q -n nautilus-47.2
cd %{_builddir}/nautilus-47.2
pushd ..
cp -a nautilus-47.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738781220
