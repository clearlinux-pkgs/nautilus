...
Version  : 3.30.2
Release  : 27
URL      : https://download.gnome.org/sources/nautilus/3.30/nautilus-3.30.2.tar.xz
Source0  : https://download.gnome.org/sources/nautilus/3.30/nautilus-3.30.2.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1539373475
export AR=gcc-ar
