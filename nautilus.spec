...
Version  : 48.3
Release  : 105
URL      : https://download.gnome.org/sources/nautilus/48/nautilus-48.3.tar.xz
Source0  : https://download.gnome.org/sources/nautilus/48/nautilus-48.3.tar.xz
...
%prep
%setup -q -n nautilus-48.3
cd %{_builddir}/nautilus-48.3
pushd ..
cp -a nautilus-48.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751314673
