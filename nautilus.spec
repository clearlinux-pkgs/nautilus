...
Source0  : https://download.gnome.org/sources/nautilus/40/nautilus-40.0.tar.xz
...
%prep
%setup -q -n nautilus-40.0
cd %{_builddir}/nautilus-40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619118821
...
cp %{_builddir}/nautilus-40.0/LICENSE %{buildroot}/usr/share/package-licenses/nautilus/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/nautilus-40.0/libnautilus-extension/LICENSE %{buildroot}/usr/share/package-licenses/nautilus/9a647436aa2324c4cb849c6f3d31c392ed50d9bd
